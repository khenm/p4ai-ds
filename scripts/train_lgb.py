...
from src.models.cnn import MultiTaskResNet
...
def main():
    ...
    model = MultiTaskResNet(extract_features=True).to(device)
    ...
    clf_final = lgb.LGBMClassifier(n_estimators=200, learning_rate=0.05, max_depth=5, random_state=42, n_jobs=-1)
